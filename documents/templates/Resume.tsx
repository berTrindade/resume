...
Resume.PreviewProps = {
  ...
  summary: "Experienced professional with expertise in [your field/industry]. Passionate about [your key interests/specialties]. Track record of [key achievements].",
  contact: {
